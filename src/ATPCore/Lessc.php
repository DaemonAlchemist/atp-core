...
$this->pushEnv();
$parser = new \ATPCore\lessc_parser($this, __METHOD__);
...
$parser = new \ATPCore\lessc_parser($this, $name);
...
$className = "\ATPCore\lessc_formatter_lessjs";
if (!empty($this->formatterName)) {
if (!is_string($this->formatterName))
return $this->formatterName;
$className = "\ATPCore\lessc_formatter_$this->formatterName";
}
...
self::$operatorString =
'('.implode('|', array_map(array('\ATPCore\Lessc', 'preg_quote'),
array_keys(self::$precedence))).')';

$commentSingle = \ATPCore\Lessc::preg_quote(self::$commentSingle);
$commentMultiLeft = \ATPCore\Lessc::preg_quote(self::$commentMultiLeft);
$commentMultiRight = \ATPCore\Lessc::preg_quote(self::$commentMultiRight);
...
$pattern = implode("|",
array_map(array("\ATPCore\Lessc", "preg_quote"), $directives));
...
$patt = '([^\n]*?)(@\{|\\\\|' .
\ATPCore\Lessc::preg_quote($delim).')';
